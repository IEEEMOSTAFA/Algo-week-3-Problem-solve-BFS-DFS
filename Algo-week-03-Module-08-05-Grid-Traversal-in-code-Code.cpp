...
Example
       ...
       //5=number of row /8=number of collum
Input:
5 8
########
#.A#...#
...
#......#
########
//amra .golu dea colacol korte parbo.kintu # golo  dea cola chol korte parbo na_____
Output:
YES
9
LDDRRRRRU
...
amra use korbo
# -> -1
. ->0  //. golo ke amra kico i korbo na
...
x state ki jog hoi | y sate ki jog hoi
x  y
-  -
0  1
0  -1
